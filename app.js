...
function obtenerUbicacion() {
  ...
  return new Promise(resolve => {
    ...
    const ubicacionCorrecta = posicion => {

      const latitud = posicion.coords.latitude;

      const longitud = posicion.coords.longitude;

      resolverUnaVez(`https://maps.google.com/?q=${latitud},${longitud}`);
    ...
    const mensajeError = error => {
      ...
      if (error?.code === 1) {
        ...
        return "No fue posible acceder a la ubicación. Revisa el permiso de ubicación de Safari o de la app instalada";
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      primerError => {
        ...
        console.warn("Primer intento de ubicación falló. Se hará un segundo intento.", primerError);
        ...
        setTimeout(() => {
          ...
          navigator.geolocation.getCurrentPosition(
            ...
            segundoError => resolverUnaVez(mensajeError(segundoError)),
