    ...
    navigator.geolocation.getCurrentPosition(
      ...
      error => {
        ...
        if (error.code === 1) {
          ...
          resolve("Permiso de ubicación rechazado");
        ...
        if (error.code === 2) {
          ...
          resolve("Ubicación no disponible en este momento");
        ...
        if (error.code === 3) {
          ...
          resolve("El GPS tardó demasiado en responder");
        ...
        resolve("No fue posible obtener la ubicación");
