...
function obtenerUbicacion() {
  ...
  return new Promise(resolve => {
    ...
    if (!navigator.geolocation) {
      ...
      resolve("Ubicación no disponible en este dispositivo");
    ...
    const guardarMejorPosicion = posicion => {
      ...
      const precision = Number(posicion.coords.accuracy || Infinity);

      const antiguedad = Date.now() - Number(posicion.timestamp || Date.now());
      ...
      if (
        ...
        precision < Number(mejorPosicion.coords.accuracy || Infinity)
      ...
      if (precision <= 50) {
        ...
        finalizar(crearEnlace(posicion));
    ...
    watchId = navigator.geolocation.watchPosition(
      ...
      error => {
        ...
        if (mejorPosicion) {
          ...
          finalizar(crearEnlace(mejorPosicion));
    ...
    temporizador = setTimeout(() => {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        posicion => finalizar(crearEnlace(posicion)),

        error => finalizar(mensajeError(error)),
